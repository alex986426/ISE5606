...
f = open('楼盘数据.csv',mode='a', encoding='utf-8', newline='')
...
for li in lis:
    title = li.css('.resblock-list-container .resblock-list-wrapper .resblock-list .resblock-desc-wrapper .resblock-name .name ::text').get() #名称
    if title:
