...
df = pd.read_csv('../101Tim_DataMining/new1.csv')
df.head
...
#%%
# 定义新文件的路径
new_file_path = '../101Tim_DataMining/new2.csv'
...
#%%
# 定义新文件的路径
new_file_path = '../101Tim_DataMining/new3.csv'

# 将修改后的数据保存为新的 CSV 文件
df.to_csv(new_file_path, index=False)

print(f"修改后的数据已保存到 {new_file_path}")
df = pd.read_csv('../101Tim_DataMining/new3.csv')
df.head
...
#%%
# 定义新文件的路径
new_file_path = '../101Tim_DataMining/new5.csv'

# 将修改后的数据保存为新的 CSV 文件
df.to_csv(new_file_path, index=False)

print(f"修改后的数据已保存到 {new_file_path}")
df = pd.read_csv('../101Tim_DataMining/new5.csv')
df.head
#%%
# 要更改的旧列名
old_column_name = '标签'
...
new_column_name = '均价/平方米每元'
#%%
file_path = '../101Tim_DataMining/new5.csv'  # 检查旧列名是否存在
